...
public class FragmentPostBindingImpl extends FragmentPostBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.txt_post_label, 1);
        sViewsWithIds.put(R.id.rv_post, 2);
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.postViewModel == variableId) {
            setPostViewModel((com.app.pravin_unit_testing.ui.post.PostViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setPostViewModel(@Nullable com.app.pravin_unit_testing.ui.post.PostViewModel PostViewModel) {
