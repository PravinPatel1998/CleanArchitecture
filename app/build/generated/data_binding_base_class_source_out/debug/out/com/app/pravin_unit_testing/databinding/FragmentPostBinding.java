...
public abstract class FragmentPostBinding extends ViewDataBinding {
  ...
  protected FragmentPostBinding(Object _bindingComponent, View _root, int _localFieldCount,
      CircularProgressIndicator progressCircular, RecyclerView rvPost, TextView txtPostLabel) {
    super(_bindingComponent, _root, _localFieldCount);
    this.progressCircular = progressCircular;
    this.rvPost = rvPost;
    this.txtPostLabel = txtPostLabel;
  }

  public abstract void setPostViewModel(@Nullable PostViewModel postViewModel);
