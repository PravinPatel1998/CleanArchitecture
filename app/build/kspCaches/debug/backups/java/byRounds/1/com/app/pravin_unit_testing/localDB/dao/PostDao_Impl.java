...
public final class PostDao_Impl implements PostDao {
  ...
  public PostDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfPostModel = new EntityInsertionAdapter<PostModel>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `PostModel` (`userId`,`id`,`title`,`body`) VALUES (?,?,?,?)";
      }
  ...
  @Override
  public void insertAll(final List<PostModel> postModel) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __insertionAdapterOfPostModel.insert(postModel);
  ...
  public List<PostModel> getAllPost() {
    final String _sql = "Select * from postmodel";
    ...
    try {
      ...
      while (_cursor.moveToNext()) {
        ...
        _item = new PostModel(_tmpUserId,_tmpId,_tmpTitle,_tmpBody);
        _result.add(_item);
      }
      return _result;
    } finally {
