...
public abstract class Hilt_Post extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((Post_GeneratedInjector) this.generatedComponent()).injectPost(UnsafeCasts.<Post>unsafeCast(this));
    }
  }
